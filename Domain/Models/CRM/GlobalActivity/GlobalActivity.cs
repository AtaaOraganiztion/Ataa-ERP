...
public class GlobalActivity : Entity, ISoftDeletableEntity
{
    ...
    // Global activities might not be linked to specific CRM entities, 
    // but we keep the structure similar if needed.
    ...
    {
        public Ulid GlobalActivityId { get; set; }
        ...
        public virtual GlobalActivity? GlobalActivity { get; set; }
